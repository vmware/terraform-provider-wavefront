...
description: |-
Get the information for a given Dashboard from Wavefront
---

# Data Source: wavefront_dashboard

Use this data source to get information for a given dashboard by id from Wavefront.
