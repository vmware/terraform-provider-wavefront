...
const (
	...
	hostKey                               = "host"
	firingKey                             = "firing"
	inMaintenanceHostLabelPairsKey        = "in_maintenance_host_label_pairs"
	failingHostLabelPairsKey              = "failing_host_label_pairs"
	evaluateRealtimeDataKey               = "evaluate_realtime_data"
	canViewKey                            = "can_view"
	canModifyKey                          = "can_modify"
	severityListKey                       = "severity_list"
	notificationResendFrequencyMinutesKey = "notification_resend_frequency_minutes"
	resolveAfterMinutesKey                = "resolve_after_minutes"
	displayExpressionKey                  = "display_expression"
	thresholdTargetsKey                   = "threshold_targets"
